...
public class ConnectionFactory {
    ...
    public ConnectionFactory(){
        try {
            ...
            prop = new Properties();
            prop.loadFromXML(new FileInputStream("D:/OneDrive/Documents/InventoryManagementSystem[1]/InventoryManagementSystem/src/com/inventory/Database/DBCredentials.xml"));
        } catch (IOException e) {
            e.printStackTrace();
        }
